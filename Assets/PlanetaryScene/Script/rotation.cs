...
public class PlanetGestureRotationAndScale : MonoBehaviour
{
    ...
    void HandlePinchScaling(SG_HandPose pose)
    {
        ...
        // Auto-shrinking behavior removed: do not modify scale when not pinching.
        // Scale will only change in response to the pinch gesture (and will be
        // clamped between minScale and maxScale). This prevents unwanted
        // automatic shrinking when the object is released.
    }
}